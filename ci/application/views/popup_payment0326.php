...
<form action="<?php echo setting::$BASE_URL ?>/member/register/paid/" method="post"
      enctype="application/x-www-form-urlencoded">
          <table border="0" cellspacing="1" cellpadding="1" width="98%" style="text-align: left;">
        <tr valign="middle">
            <td><font class="title">การชำระเงิน / ต้องการให้ออกใบเสร็จในนาม
            </font>
            </td>
        </tr>
  ...
  <tr valign="top">
      <td  width="180" align="left"><!--text descrip--><br/><font class="bottomtext"><strong>หมายเหตุ</strong></font><br/>
                            เมื่อท่านกดปุ่มตกลงแล้ว ทางโปรแกรมจะจัดส่งใบแจ้งชำระเงินให้ท่านทาง email ที่ท่านลงทะเบียนไว้
                            เพื่อให้ท่านนำไปชำระเงินที่ เคาเตอร์ธนาคารกรุงไทยทุกสาขา<br/><br/>ทางสถาบันจะส่งใบยืนยันการรับชำระกับท่านอีกครั้งทาง
                            ...
                            <font class="bottomtext"><strong>โปรดชำระเงินภายใน 15 วันหลังจากที่ท่านได้สำรองที่นั่ง
                                เพื่อสำรองสิทธิ <br/><br/>หากเกิน 15 วัน
                                ทางสถาบันจะยกเลิกการสำรองที่นั่งของท่าน</strong></font><br />
<br /><font class="smtext">
  <strong> สอบถามรายละเอียดเพิ่มเติมได้ที่ </strong><br/>
                            ...
                            88/39 <br/>กระทรวงสาธารณสุข ซอย 6 <br/>อาคารสุขภาพแห่งชาติ ชั้น 5 ถ.ติวานนท์ <br/>
                            ต.ตลาดขวัญ อ.เมือง จ.นนทบุรี 11000<br/>
                            โทรศัพท์ 0-2832-9461 - 65,<br/> 2-0832-9412-22 <br/>
                            โทรสาร 0-2832-9540</font><!--text descrip--></td>
                            
        <td width="10" class="verticle"><img src="images/blank.gif" width="10" height="60" border="0"/></td>
                        <td width="5">&nbsp;</td>

    <td align="left" width="200"><!--payment type add1-->
                    <table width="100%" border="0" cellpadding="1">
                    <tr valign="top">
                        <td width="10"><input name="receipt_type" type="radio" value="self"/></td>
                        <td align="left" width="200"><strong>ออกใบเสร็จในนามท่านเอง:</strong> <br/><br/>
                            <?php
                            ...
                            <!--payment type add1--></td>
                                    <td width="10" class="verticle"><img src="images/blank.gif" width="10" height="60" border="0"/></td>
                        <td width="5">&nbsp;</td>
    <td align="left" width="180"><!--payment type add2-->    <table width="100%" border="0" cellpadding="1">
                    <tr valign="top">
                        <td width="10"><input name="receipt_type" type="radio" value="other"/></td>
                    <td align="left" width="180"><strong>ออกใบเสร็จในนามรพ. หรืออื่นๆ</strong><br/><br/>
                    ชื่อ นามสกุล<br/>
                            ...
                            <!--payment type add2--></td>
                                    <td width="10" class="verticle"><img src="images/blank.gif" width="10" height="60" border="0"/></td>
                        <td width="5">&nbsp;</td>
    <td align="left"><!--payment type add3-->  
    <table width="100%" border="0" cellpadding="1">
                    <tr valign="top">
                        <td width="10"><input name="receipt_type" type="radio" value="separate" <?php if($regis_bill==false){?> disabled="disabled"<?php }?>/></td>
...
</table><!--payment type add3--><br/><p align="center">                <input type="hidden" name="courseID" value='<?php echo $courseID?>'>
                <input type="hidden" name="register" value='<?php echo $data?>'>
                <input id="submit-payment" type="image" src="images/b_send.gif" width="107" height="24"></p></td>
  </tr>
</table>

    
</form><!--payment type add-->
