...
<form id="frm_search" method="get" action="<?php echo setting::$BASE_URL?>/search"
      enctype="application/x-www-form-urlencoded"><img src="images/statustab1.gif" width="681" height="127" border="0">
...
<table border="0" width="680"  bgcolor="#eaeaea"align="center">
    ...
    if ($data == false):
        ...
        foreach ($data as $key => $val):
            ...
            $txtStatus = (intval($val['isPaid']) !== 1) ? 'รอชำระเงิน' : 'ชำระเงินแล้ว';
            $seat = $val['seatNo'];
            $row++;
            ?>
            <tr valign="middle">
