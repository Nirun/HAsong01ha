  ...
  <tr>
    <td  bgcolor="#defb9d"><input name="registerBy" type="radio" value="3"
                   ...
                   <!-- <tr valign="top">
                    ...
                    <tr valign="top">
                        <td> <img src="images/des3.gif" width="683" height="61">
                        </td>
                    </tr>
                    <!--add name-->
                    <?php
                        ...
                        <tr valign="top">
                            <td class="tab reserve">
                                <table width="98%" border="0" cellspacing="2" cellpadding="2">
                                    <tr>
                                        <td align="left" class="info"> <?php echo $i?>.
                                        </td>
                                        ...
                                        <td align="left" class="info">ชื่อ<br/>
                                            <input name="name[]" type="text" class="info_enable">
                                        </td>
                                        <td align="left" class="info">นามสกุล<br/>
                                            <input name="lastname[]" type="text" class="info_enable">
                                        </td>
                    ...
                    <tr valign="middle">
                        <td class="info" align="center"><br/>
                            ...
                            <a id="payment" rel="<?php echo $courseID ?>"><img
                                    src="images/b_reserve_pay.gif" width="120" height="17" border="0"
