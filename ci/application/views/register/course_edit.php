            ...
            <td align="left" class="info"> ประเภทของ course นี้<br/>
                <select name="coursetype" id="coursetype">
                    ...
                    foreach ($course_type as $val):
                        ...
                        ?>
                        <option value="<?php echo($val['coursetypeID']); ?>" <?=$selCT?>><?php echo($val['coursetype']);?></option>
                    <?php
                    endforeach
                    ?>
                </select>
    ...
    <td align="left" class="info" colspan="2">
        ...
        <table border="0" cellspacing="3" cellpadding="3">
            ...
            <tr valign="middle">
                ...
                <td><input onClick="ds_sh(this);" name="registstartdate" id="registstartdate" readonly="readonly"
                           style=" width: 120px;  border-top:1px solid #BEC4DC; border-left:1px solid #BEC4DC; border-right:1px solid #7984B6; border-bottom:1px solid #9197B5; background:#ffffff;   padding-top:1px; padding-bottom:1px; margin-top:3px; margin-bottom:3px;cursor: text;"
            ...
            <tr valign="middle">
                ...
                <td colspan="3"><input onClick="ds_sh(this);" name="payenddate" id="payenddate" readonly="readonly" value="<?php echo $PayeDate; ?>"
                                       style=" width: 120px;  border-top:1px solid #BEC4DC; border-left:1px solid #BEC4DC; border-right:1px solid #7984B6; border-bottom:1px solid #9197B5; background:#ffffff;   padding-top:1px; padding-bottom:1px; margin-top:3px; margin-bottom:3px;cursor: text;">
                        ...
                        foreach ($optional as $_optional):
                            ...
                            if ($total_row == 0) {
                                ...
                                <td colspan="5"><input name="optionalother" type="text"
                                                       ...
                                                       value="<?php echo($data['optionalother']);?>"></td>
                                <?php
                            }
    ...
    <td align="left" class="info">
        ...
        for ($i = 0; $i <= 2; $i++) {
            ...
            <table border="0" cellspacing="3" cellpadding="3">
                ...
                <tr align="left">
                    <td class="info"> หัวข้อเอกสาร : <input type="text" name="doctitle[]" size="60"
                                                            value="<?php echo $title; ?>"></td>
                </tr>
                <tr align="left">
                    <td class="info">
                        <a href="<?php echo Setting::$PATH_PDF . $file; ?>" target="_blank">
                            <img src="register/images/file.gif" width="22" height="26" border="0">
