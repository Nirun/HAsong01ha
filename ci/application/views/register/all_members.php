<div id="container"><font class="title">รายชื่อสมาชิกทั้งหมด</font>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr valign="top">
        <td align="left"><!--<input type="button" value="  เพิ่มรายชื่อสมาชิก " class="button"
        ...
        <td align="right"><!--search-->
            <form name="form_search" method="get" enctype="application/x-www-form-urlencoded" id="form_search"
                  action="register/user/all_members/1/">

                <!--search--><font class="bottomtext">ค้นหารายชื่อสมาชิก
...
<!--page-->
<!--
รายชื่อผู้เข้าร่วมอบรมทั้งหมด เรียงลำดับการอบรมที่เปิดล่าสุด<br/>
...
<br/>
    <?php endif; */?><!--<strong>จำนวนผู้ลงทะเบียนแล้ว</strong>
<?php echo(strval($totalRegister)); ?> คน <br/>-->
<!--article-->
<table border="0" cellspacing="2" cellpadding="2">
    ...
    <tr valign="top" bgcolor="#a0cdf9">
        ...
        <td align="center" height="30"><p class="fronttext">ประวัติการสมัคร</p></td>
    ...
    if (count($data) > 0):
        ...
        foreach ($data as $val):
            $row++;
            $name = ($val['prefix'] != '6') ? $val['prefix_name'] : $val['prefix_other'];
            $name .= $val['name'] . ' ' . $val['lastname'];
            $hospital = (trim($val['hospital_name'] != '')) ? $val['hospital_name'] : $val['hospital_name'];
            ...
            <tr valign="top">
                ...
                <td align="center" class="info"><input type="button"
                                                       onClick="if(confirm('<?php echo Msg::$delete ?>')){location='<?php echo setting::$BASE_URL;?>/register/user/user_delete/<?php echo $traineeID ?>';}"
                                                       value="Delete"/></td>
            </tr>
            <?php
        endforeach; else :
