    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(".btn").click(function () {
                ...
                if (dataString != " "){
                    var url = "<?php echo setting::$BASE_URL ?>/register/course/preview/tag/" + cID + "/" + dataString + "/" + checkall;
...
<table border="0" cellspacing="2" cellpadding="2">
    <tr valign="middle">
        <td colspan="4"><font class="title">ป้ายชื่อผู้เข้าอบรม / พิมพ์ป้ายชื่อผู้เข้าอบรม 
        </font>
...
<!--            --><?php //echo $countRegister; ?><!-- คน <br />-->
            ...
            <br /><br>
            <a target="_blank" href="<?php echo setting::$BASE_URL.'/register/course/applylist/taglist/'.$courseID;?>">
                <img src="<?php echo Setting::$BASE_URL;?>/register/images/excel.jpg" border="0">
            </a>
            <br>
            <br>
            <label for="sel_template">เลือกรูปแบบใบรายชื่อ</label>
    ...
    <?php if ($cntPaid == 0) { ?>
    <tr valign="middle">
        <td align="center" class="tab" colspan="5">ไม่พบรายชื่อผู้ลงทะเบียน</td>
    </tr>
    <?php } else { ?>
    <tr valign="middle">
    ...
    <form id="form_tag" name="form_tag" action="register/course/previewtags" method="post">
     <tr valign="middle">
         <td colspan="5" align="right" class="info">
         
    
<p align="left">  <strong>***********  กรณีต้องการพิมพ์ป้ายชื่อผู้เข้าอบรม<font color="#FF0000"> โปรด set up  การพิมพ์ โดยเลือกให้พิมพ์ background ด้วย</font> *********** <br /></strong>
  หากต้องการขยับ หรือ แก้ไขขนาดตัวหนังสือป้ายชื่อผู้เข้าอบรม โปรดเลือก ป้ายชื่อผู้เข้าอบรมจากเมนูด้านบน จากนั้นเลือก จัดการป้ายชื่อผู้เข้าอบรม แนะนำให้เปิดสองหน้าต่างพร้อมกันและ refresh  หน้า preview  เมื่อทำการ save ในหน้า edit  
  <br /><br />
  กรณีชื่อ หรือ ชื่อรพ. ยาวมาก แนะนำให้จัดหมวดหมู่  และจัดขนาดตัวหนังสืออีกครั้งก่อนเลือกพิมพ์อีกครั้ง </p>
   <br /> <br />
             <input type="checkbox" name="checkall" id="selectall"/> เลือกทั้งหมด
         </td>
     </tr>
    <tr valign="middle" bgcolor="#a0cdf9">
        <td align="center" height="30"><p class="fronttext">ลำดับ</p></td>
        <td align="center" height="30"><p class="fronttext"></p></td>
    ...
    foreach ($reglist as $_reglist):
        ...
        <tr valign="middle" bgcolor="<?php echo $bgcolor; ?>">
            ...
            <td align="left" width="50p" class="info"><?php echo $prefix; ?></td>
            ...
            <td align="center" class="info"><input name="selectedID[]" class="case" type="checkbox"
                                                   value="<?php echo $registerD; ?>"/></td>
        </tr>
        <?php
        $i++;
    endforeach;
