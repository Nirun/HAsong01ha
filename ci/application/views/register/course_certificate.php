<div id="container"><font class="title">พิมพ์ใบประกาศนียบัตรผู้เข้าอบรม</font>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr valign="top">
            <td align="left">&nbsp;
                <a href="manage/cert">
                    <button class="btn_cert">จัดการหน้าประกาศนียบัคร</button>
                </a>
            </td>
            <td align="right">
                <!--search-->
                <form name="frm" method="get" enctype="application/x-www-form-urlencoded" id="frm"
                      action="<?php echo setting::$BASE_URL;?>/register/certificate/index/1/">
...
margin-top:2px; margin-bottom:2px;">
    ...
    <?php if ($cntCourse == 0) { ?>
        <table border="0" cellspacing="2" cellpadding="2">
            <tr valign="top">
                <td align="left"><img src="<?php echo setting::$BASE_URL; ?>/register/images/blank.gif" alt=""
                                      width="150" height="1" border="0"></td>
                <td align="left"><img src="<?php echo setting::$BASE_URL; ?>/register/images/blank.gif" alt=""
                                      width="330" height="1" border="0"></td>
                <td align="left"><img src="<?php echo setting::$BASE_URL; ?>/register/images/blank.gif" alt=""
                                      width="60" height="1" border="0"></td>
                <td align="left"><img src="<?php echo setting::$BASE_URL; ?>/register/images/blank.gif" alt=""
            ...
            foreach ($data as $val):
                ...
                <tr valign="top" bgcolor="<?php echo $bgcolor; ?>">
                    ...
                    <td align="center" class="info">
                        <a href="register/course/applylist/certificate/<?php echo $courseID;?>">
<!--                        <a href="register/course/applylist/certificate/--><?php //echo $courseID;?><!--?height=550&width=980"-->
<!--                           class="thickbox" rel="thickbox_slide1">-->
                            <img src="<?php echo setting::$BASE_URL; ?>/register/images/printcer.gif" width="129"
                                 height="22" border="0"/>
                        </a>
                    </td>
                </tr>
